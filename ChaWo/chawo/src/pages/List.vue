    ...
    <header style="height: 100px;position:fixed;top:0;left:0;width:100%;z-index:100">
      ...
      <div class="goods-search-list-nav">
        <ul id="nav_ul">
          ...
          <li>
            <a class="nav-2-4" onclick="init_get_list('2', '4')">新上架</a>
          </li>
          <li>
            <a class="nav-2-2" onclick="init_get_list('2', '2')">人气</a>
          </li>
          <li>
            <el-dropdown trigger="click">
              <span class="el-dropdown-link">
    ...
    <main style="margin-top:100px">
      <ul style="width:100%">
        <li
          v-for="(item) in list"
          :key="item._id"
          style="width:100%;margin-bottom:10px;height:130px"
          @click="godetail(item)"
        >
          ...
          <div style="float:right;width:65%;height:100%">
            ...
            <p style="margin: 0">
              <i style="font-size:12px;color:#ccc;margin:5px">销量</i>
              {{item.Xl}}
            </p>
            <el-divider></el-divider>
          </div>
